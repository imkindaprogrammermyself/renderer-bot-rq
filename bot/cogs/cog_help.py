...
from ..checks import check_is_valid_channel
...
class Help(Cog):
    ...
    @commands.check(check_is_valid_channel)
    ...
    async def help(self, ctx: Context):
        ...
        try:
            try:
                ...
                embed.add_field(name="\u200B", value=f"{MSG_GVT802}({URL_PAYPAL})", inline=False)
    ...
    async def _render(self, ctx: Context):
        ...
        embed.add_field(name=f"Syntax", value=MSG_RKN680.format(*[f'{PREFIX}render'] * 6), inline=False)
